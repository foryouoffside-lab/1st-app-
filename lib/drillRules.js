...
export const SOLO_RULES = {
  ...
  //
  // ONE EXCEPTION: Shade Finder does not use this file's economy at all. It
  // runs a "sprint" — a hard 45s countdown (no earn-time) plus 5 local lives —
  // because a slow visual-search task is a chore stretched over minutes. That
  // is self-contained in ShadeFinderClient.js; it does not read these flags.
  LIVES_ENABLED: false,
  MAX_LIVES: 5,
