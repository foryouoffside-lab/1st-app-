...
export const CATEGORY_CONFIG = {
  fps: {
    basePoints: 10,
    fastWindow: 400,   // ms — "fast" threshold
    livesEnabled: false,
    description: 'FPS Training',
  },
  'reaction-speed': {
    basePoints: 8,
    fastWindow: 350,
...
// ─────────────────────────────────────────────────────────────────────────────
// PERCENTAGE HELPER — normalize any drill score to 0–100
// ─────────────────────────────────────────────────────────────────────────────

/**
 * Normalize a raw score to a 0–100 percentage for grading.
 * @param {number} score — actual score
 * @param {number} maxPossible — theoretical maximum score for this session
...
// These match the old export names used by useGameEngine.js and individual drills.
// They delegate to the new unified API above.
// ─────────────────────────────────────────────────────────────────────────────

/** @deprecated Use CATEGORY_CONFIG */
export const DRIFFICULTY_CONFIG = CATEGORY_CONFIG;

/** @deprecated Use getGrade() */
...
/**
 * @deprecated Use scoreAction()
 * Kept for backward compat with useGameEngine.js and individual drill files.
 */
